...
<!-- End Google Tag Manager -->
        <title>
            Reset Password - NXTDROP - Canada's #1 Sneaker Marketplace
        </title>
        ...
        <script type="text/javascript" src="pwd.rec/newpwd.js"></script>
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div class="container">
            <form action="" method="POST" class="reset-form" id="signup">
                <input type="password" name="pwd" id="pwd" placeholder="New Password" required><br>
                <input type="password" name="cPwd" id="cPwd" placeholder="Confirm New Password" required><br>
