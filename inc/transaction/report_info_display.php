<?php
    ...
    <p id="transaction_comment"><b>COMMENT:</b> '.$comment.'</p>
    <p><b>SELLER RATED YOU:</b> '.$seller_rating.' <span><i class="fa fa-star" aria-hidden="true"></i></span></p>';
?>  