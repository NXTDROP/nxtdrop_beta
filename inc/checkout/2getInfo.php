<?php
    ...
    if(!isset($_SESSION['uid'])) {
        ...
        if($item_ID == "") {
            ...
            $query = "SELECT o.retailPrice, p.assetURL, p.model FROM products p, holidayOffers o, notifications n WHERE o.productID = '$item_ID' AND o.productID = p.productID AND n.target_id = '$n_ID' AND n.post_id = o.productID AND n.notification_type = 'promo'";
