...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div id="promo">
            ...
            <div id="most-popular">
                ...
                <?php
                    if(isset($_SESSION['uid'])) {
                        $getMostPopular = $conn->prepare("SELECT products.productID, products.model, products.assetURL, (SELECT COUNT(*) FROM heat WHERE productID = products.productID) AS heat, (SELECT COUNT(*) FROM cold WHERE productID = products.productID) AS cold, (SELECT MIN(price) FROM offers, transactions WHERE productID = products.productID AND offerID != transactions.itemID) AS minPrice, (SELECT COUNT(userID) FROM heat WHERE userID = ? AND heat.productID = products.productID) AS heated, (SELECT COUNT(userID) FROM cold WHERE userID = ? AND cold.productID = products.productID) AS froze FROM products, product_rank WHERE products.productID = product_rank.productID ORDER BY product_rank.rank DESC LIMIT 4;");
                        ...
                        $getMostPopular = $conn->prepare("SELECT products.productID, products.model, products.assetURL, (SELECT COUNT(*) FROM heat WHERE productID = products.productID) AS heat, (SELECT COUNT(*) FROM cold WHERE productID = products.productID) AS cold, (SELECT MIN(price) FROM offers, transactions WHERE productID = products.productID AND offerID != transactions.itemID) AS minPrice FROM products, product_rank WHERE products.productID = product_rank.productID ORDER BY product_rank.rank DESC LIMIT 4;");
                        $getMostPopular->execute();
            ...
            <div id="new-releases">
                ...
                <?php
                    ...
                    if(isset($_SESSION['uid'])) {
                        $getNewReleases = $conn->prepare("SELECT products.productID, products.model, products.assetURL, (SELECT COUNT(*) FROM heat WHERE productID = products.productID) AS heat, (SELECT COUNT(*) FROM cold WHERE productID = products.productID) AS cold, (SELECT MIN(price) FROM offers, transactions WHERE productID = products.productID AND offerID != transactions.itemID) AS minPrice, (SELECT COUNT(userID) FROM heat WHERE userID = ? AND heat.productID = products.productID) AS heated, (SELECT COUNT(userID) FROM cold WHERE userID = ? AND cold.productID = products.productID) AS froze FROM products WHERE products.yearMade <= ? ORDER BY products.yearMade DESC LIMIT 4;");
                        ...
                        $getNewReleases = $conn->prepare("SELECT products.productID, products.model, products.assetURL, (SELECT COUNT(*) FROM heat WHERE productID = products.productID) AS heat, (SELECT COUNT(*) FROM cold WHERE productID = products.productID) AS cold, (SELECT MIN(price) FROM offers, transactions WHERE productID = products.productID AND offerID != transactions.itemID) AS minPrice FROM products WHERE products.yearMade <= ? ORDER BY products.yearMade DESC LIMIT 4;");
            ...
            <div id="feed">
                ...
                <?php
                    if(isset($_SESSION['uid'])) {
                        $getProducts = $conn->prepare("SELECT products.productID, products.model, products.assetURL, (SELECT COUNT(*) FROM heat WHERE productID = products.productID) AS heat, (SELECT COUNT(*) FROM cold WHERE productID = products.productID) AS cold, (SELECT MIN(price) FROM offers, transactions WHERE productID = products.productID AND offerID != transactions.itemID) AS minPrice, (SELECT COUNT(userID) FROM heat WHERE userID = ? AND heat.productID = products.productID) AS heated, (SELECT COUNT(userID) FROM cold WHERE userID = ? AND cold.productID = products.productID) AS froze FROM products ORDER BY RAND() LIMIT 12;");
                        ...
                        $getProducts = $conn->prepare("SELECT products.productID, products.model, products.assetURL, (SELECT COUNT(*) FROM heat WHERE productID = products.productID) AS heat, (SELECT COUNT(*) FROM cold WHERE productID = products.productID) AS cold, (SELECT MIN(price) FROM offers, transactions WHERE productID = products.productID AND offerID != transactions.itemID) AS minPrice FROM products ORDER BY RAND() LIMIT 12;");
                        $getProducts->execute();
