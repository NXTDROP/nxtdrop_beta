    ...
    <body>
        <div class="container email_container">
            <div class="header">
                ...
                <p style="text-align: center; font-family: Roboto, sans-serif; margin: 0 0 0 0; font-size: 0.60rem; font-weight: 500;">Your order is legit!</p>
            </div>
            ...
            <div class="content" style="overflow: hidden;">
                <table style="margin: 10px;">
                    ...
                    <tr style="font-size: 14px;">
                        <td style="color: #727272;">Status: verified</td>
                    </tr>
                </table>
