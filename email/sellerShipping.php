<?php
    ...
    if($row['transactionID'] != '') {
        ...
        $carrier = $row['seller_Carrier'];
        $tracking = $row['seller_TrackingNumber'];
    ...
    <body>
        <div class="container email_container">
            <div class="header">
                ...
                <h2 style="font-size: 1.5rem; text-align: center; margin: 0 0 10px 0; font-family: Archive Black, sans-serif;">YOUR ORDER IS ARRIVING!</h2>
                ...
                <p style="text-align: center; font-family: Roboto, sans-serif; margin: 0 0 0 0; font-size: 0.60rem; font-weight: 500;">We are glad to announce that your order is on its way to you.</p>
            </div>
